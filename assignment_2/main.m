...
probabilities0 = arrayfun(@(l) (l^0 * exp(-l)) / factorial(0), lambdavec);
probabilities1 = arrayfun(@(l) (l^1 * exp(-l)) / factorial(1), lambdavec);

EBO2 = lambdavec.*Tvec - 2 + 2*probabilities0 + probabilities1
Cost2 = sum(cvec*2)
